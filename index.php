		...
		<div class="navbar-wrapper">
			<div class="container">
				<div class="navbar-inner">
					...
					<div class="navbar-extra d-flex align-items-center" id="login">
						<a href="login.php" class="main-btn nav-btn d-none d-sm-inline-block">
							Login
						</a>
						<a href="login.php">
							<span></span>
					...
					<div class="hero-text">
						...
						<ul class="hero-btn">
							<li class="wow fadeInUp" data-wow-delay="0.4s">
								<a href="project-details.php" class="main-btn">Explore Services <i class="far fa-arrow-right"></i></a>
							</li>
							<li class="wow fadeInUp" data-wow-delay="0.5s">
								<a href="//www.youtube.com/watch?v=XSGBVzeBUbk" class="video-btn" data-lity><i class="fas fa-play"></i></a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="row align-items-center justify-content-lg-start justify-content-center">
				...
				<div class="col-xl-4 col-lg-5 col-md-10 offset-xl-1">
					<div class="about-text mt-md-70 mb-md-50">
						...
						<p>
							YouthCare is a facility to learn about health education, both physically and mentally, especially for teenagers.
						</p>
			...
			<div class="row align-items-center justify-content-center">
				<div class="col-xl-4 col-lg-6 col-md-8 col-sm-10">
					<div class="testimonials-content mb-lg-50">
						...
						<a href="testimonial.php" class="main-btn mt-35">View All Reviews <i class="far fa-arrow-right"></i></a>
							...
							<div class="col-lg-6 col-md-6 col-sm-10">
								<div class="testimonial-box-one wow fadeInUp" data-wow-delay="0s">
									...
									<p class="testimonial-desc">
										Before knowing YouthCare, I stressed out of work and family problems. Then I start to open my eyes to make change and here I am now. Finally I can deal with myself and all of my problems with the help of YouthCare. Thanks a lot!
									</p>
					...
					<div class="col">
						<div class="project-item">
							...
							<div class="content">
								...
								<div class="project-stats">
									<div class="stats-value">
										<span class="value-title">Raised of <span class="value">Rp59,689</span></span><br>
					...
					<div class="col">
						<div class="project-item">
							...
							<div class="content">
								...
								<div class="project-stats">
									<div class="stats-value">
										<span class="value-title">Raised of <span class="value">Rp9,000,000</span></span><br>
